...
import { CubismId, CubismIdHandle} from '@live2d-framework/id/cubismid';
    ...
    if (this._state == LoadStep.LoadTexture) {
      ...
      for (
        ...
        const onLoad = (textureInfo: TextureInfo): void => {
          // 【新增安全判断】如果渲染器或贴图管理器已被销毁，中断执行
          if (!this.getRenderer() || !this._subdelegate || !this._subdelegate.getTextureManager()) {
            return;
          }
        ...
        // 【新增安全判断】检查 getTextureManager() 是否存在
